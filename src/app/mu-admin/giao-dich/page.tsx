  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-amber-100">Giao dịch</h1>
          <p className="text-sm text-zinc-400">Xem toàn bộ lịch sử giao dịch trên hệ thống.</p>
        </div>
      </header>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="rounded-xl border border-emerald-500/20 bg-black/25 p-4">
          ...
          <p className="mt-1 text-2xl font-extrabold text-emerald-400">{totalAmount.toLocaleString("vi-VN")}đ</p>
        </div>
        <div className="rounded-xl border border-amber-500/20 bg-black/25 p-4">
          <p className="text-sm text-zinc-300">Số giao dịch</p>
          <p className="mt-1 text-2xl font-extrabold text-amber-100">{transactions.length}</p>
        </div>
      </div>
